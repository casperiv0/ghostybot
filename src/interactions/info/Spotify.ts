    ...
    switch (type.toLowerCase()) {
      case "track": {
        ...
        const embed = this.bot.utils
          ...
          .addField({ name: lang.MUSIC.DURATION, value: data.duration })
          .addField({
...
**${lang.UTIL.SPOT_ARTISTS}:** ${artists}`,
      ...
      case "artist": {
        ...
        const embed = this.bot.utils
          ...
          .addField({ name: lang.UTIL.SPOT_GENRES, value: genres, inline: true })
          .addField({ name: lang.UTIL.SPOT_TOP, value: topTracks });
      ...
      case "album": {
        ...
        const embed = this.bot.utils
          ...
          .addField({ name: lang.UTIL.SPOT_TRACKS, value: tracks, inline: true })
          .addField({ name: lang.UTIL.RELEASE_DATE, value: data.release_date, inline: true })
          .addField({ name: lang.UTIL.SPOT_ARTISTS, value: artists, inline: true })
      ...
      case "playlist": {
        ...
        const embed = this.bot.utils
          ...
          .addField({ name: lang.UTIL.SPOT_TRACKS, value: `${tracks}\n${length}`, inline: true })
          .setImage(data.images[0].url);
