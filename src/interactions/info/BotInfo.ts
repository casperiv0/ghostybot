...
${botInvite}`,
      ...
      .addField({ name: lang.BOT.REPO, value: botRepo, inline: true })
      .addField({ name: lang.UTIL.SUPPORT_SERVER, value: supportServer, inline: true })
      .addField({ name: lang.BOT.DASHBOARD, value: dashboard, inline: true })
      .setImage(
