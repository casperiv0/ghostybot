const LANG: typeof import("./english").default = {
  ...
  PERMISSIONS: {
    ...
    DEAFEN_MEMBERS: "Sordera a los miembros",
    MOVE_MEMBERS: "Mueves a los miembros",
    ...
    MANAGE_EMOJIS_AND_STICKERS: "Administrar emojis y pegatinas",
