const LANG: typeof import("./english").default = {
  ...
  LEVELS: {
    ...
    REMOVED_XP: "Успешно отобрано **{amount}**XP у **{userTag}**",
  },
  PERMISSIONS: {
    ...
    MANAGE_EMOJIS_AND_STICKERS: "Изменять эмодзи и стикеры",
    MANAGE_THREADS: "Изменять треды",
    USE_PUBLIC_THREADS: "Использовать публичные треды",
    USE_PRIVATE_THREADS: "Использовать приватные треды",
    USE_EXTERNAL_STICKERS: "Использовать стикеры не с этого сервера",
  },
  MUSIC: {
  ...
  UTIL: {
    ...
    SPOT_TRACKS: "Треки",
    SPOT_MORE_TRACKS: "еще {tracks - 10} треков",
  ...
  ADMIN: {
    ...
    CANNOT_USE_CMD_THREAD: "Нельзя использовать эту команду в тред-канале!",
  },
  TICKET: {
  ...
  GIVEAWAY: {
    ...
    NOT_FOUND: "Не найдена раздача с id: {id}",
  },
  OTHER: {
    REGIONS: {
