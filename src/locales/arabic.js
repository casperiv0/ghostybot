module.exports = {
    ...
    ROLES: {
      ...
      MY_ROLE_MUST_BE_HIGHER:
        "يجب ان تكون رتبتي اعلي من  **{member}** ",
    ...
    MUSIC: {
      ...
      ADDED_TO_QUEUE: "تمت اضافة اغنية ال القائمة القائمة | {songs} الاغاني بالقائمة",
    ...
    ECONOMY: {
      ...
      VIEW_INVENTORY:
        "استخدم `{prefix}inventory <user>` لعرض جميع ممتلكاته",
      ...
      MEMBER_NO_MONEY:
        "لا يملك المستخدم اي اموال لذلك لا يمكنك سرقته.",
      ROB_SUCCESS: "تمت السرقة **{amount}كوينز ** من **{member}**",
      STORE: "المتجر",
      MANAGE_STORE_PERMS:
        "انت لا تمتلك الصلاحيات الكافية  (Manage Server)",
