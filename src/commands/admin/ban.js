module.exports = {
    ...
    async execute(bot, message, args) {
        ...
        banUser.user.send(`You've been **banned** from **${message.guild.name}**, Reason: **${banReason}**`);
        message.channel.send(`${banUser} was successfully banned from the server. Reason: **${banReason}**. I have also send a DM letting the person know.`);
    }
};