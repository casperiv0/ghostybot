...
module.exports = {
  ...
  async execute(bot, message, args) {
    ...
    if (!option) return message.channel.send("Please provide an valid option (\`suggest-channel / announce-channel / welcome-channel / leave-channel / audit-channel / welcome-role / mod-log\`)");
    if (!item)
