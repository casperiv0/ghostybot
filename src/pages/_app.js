    ...
    <>
      ...
      <div className="container">
        <Head>
          ...
          <meta
            name="description"
            content="🤖 {dashboard.botName} is a Custom Discord bot with a lot of commands for Discord communities. (+180 commands) Economy, util, fun, music, admin, xp system and more "
          />
          <link
